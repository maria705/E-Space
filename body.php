                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										<p class='product-category' style='color: black'>$cat_name</p>
										<h3 class='product-name header-cart-item-name'><a href='product.php?p=$pro_id' style='color: black'> $pro_title</a></h3>
