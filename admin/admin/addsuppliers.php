...
if(isset($_POST['btn_save']))
{
    ...
    $query = "INSERT INTO user_info(first_name, last_name, email, password, mobile, address1, address2) VALUES ('$first_name', '$last_name', '$email', '$hashed_password', '$mobile', '$address1', '$address2')";
