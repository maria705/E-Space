		...
		echo'
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<div class="form-group CVV">
							...
							<input type="text" class="form-control" name="cvv" id="cvv" required maxlength="3" minlength="3" pattern="\d{3}" title="CVV must be 3 digits">
						</div>
					</div>
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="Place Order" class="checkout-btn">
				</form>
				</div>
			</div>
			';
